...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[url('/src/assets/bg1.png')] bg-cover bg-center flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Collaborate, focus, and learn together
          </p>
        </div>
        ...
        <form onSubmit={createRoom} className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-md transition duration-200 flex justify-center items-center"
            >
              {loading ? (
                <svg
